...
export default React.createClass({
  ...
  onRegister (){
    ...
    this.transitionTo('parq', { userId: this.state.user._id });
  },
    ...
    return <div>
          <div className="row">
            <div className="health-details">
              {
                Strings.Forms.health.details.fields.map((field) => {
                  const info = {
                    field: 'info',
                    value: '',
                    label: field.info
...
function mountHealthState (){
  return Strings.Forms.health.details.fields.map((field) => {
